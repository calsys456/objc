...
#+begin_src common-lisp
  (c2mop:ensure-class 'objc-class:ns-object
                      ...
                      :auto-bind-properties nil   ; optionally disable auto property binding
                      :auto-register-methods nil) ; optionally disable auto method registration
  ;; or
...
#+begin_src lisp
  (make-instance (objc:cls ns-object))
#+end_src
...
#+begin_src lisp
  (make-instance (objc:cls ns-object) :objc-object <pointer>)
#+end_src
